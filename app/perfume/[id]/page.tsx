...
import { ArrowLeft, Check, ShoppingCart, Star, Youtube } from "lucide-react";
...
const COMMUNITY_REVIEWS = [
  {
    ...
    avatar: "AM",
    rating: 5,
    text: "The most complimented fragrance I've ever worn. A masterpiece of modern perfumery that I keep returning to year after year.",
    date: "Jan 2026",
  },
  {
    author: "Sophia K.",
    avatar: "SK",
    rating: 5,
    text: "Absolutely divine. The way this evolves on skin throughout the day is remarkable - it genuinely improves with time.",
    date: "Dec 2025",
  },
  {
    author: "James R.",
    avatar: "JR",
    rating: 4,
    text: "Incredible sillage. Can be challenging in warm weather but absolutely perfect for autumn and winter evenings.",
    date: "Nov 2025",
  },
  {
    author: "Mei L.",
    avatar: "ML",
    rating: 5,
    text: "Worth every penny. I've tried dozens of alternatives but none come close to the original. An icon for a reason.",
    date: "Oct 2025",
  },
];
  ...
  return (
    <div className="min-h-screen pt-20">
      <div className="max-w-7xl mx-auto px-6 pt-6">
        <Link
          href="/database"
          className="inline-flex items-center gap-2 text-xs text-ivory-muted hover:text-gold transition-colors tracking-wider uppercase"
        >
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex items-center gap-3 mb-5 justify-center md:justify-start">
                ...
                <span className="text-ivory-muted text-sm">
                  ({perfume.reviews.toLocaleString()} ratings)
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-6">
                {perfume.tags.map((t) => (
                  <span key={t} className="text-xs px-3 py-1 rounded-full border border-gold/25 text-gold/80">
                    {t}
                  </span>
                ))}
              </div>
              <div className="flex items-center gap-4 justify-center md:justify-start">
                ...
                <a
                  href="#buy"
                  className="btn-gold px-6 py-3 text-xs rounded-sm tracking-widest inline-flex items-center gap-2"
                >
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid lg:grid-cols-3 gap-10">
          ...
          <section className="glass rounded-xl p-8">
            ...
            <div className="flex flex-col items-center gap-0">
              <div className="w-full max-w-xs">
                <p className="text-center text-xs text-gold tracking-widest uppercase mb-2">
                  Top Notes | First 30 Min
                </p>
              ...
              <div className="w-full max-w-sm">
                <p className="text-center text-xs text-gold tracking-widest uppercase mb-2 mt-1">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {perfume.seasons.map((s) => (
                    <span key={s} className="note-pill">
                      {s}
                    </span>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {perfume.occasions.map((o) => (
                    <span key={o} className="note-pill">
                      {o}
                    </span>
                  ))}
                </div>
        ...
        <div className="space-y-6">
          ...
          <div className="glass rounded-xl p-6">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={lbl}
                  className="flex justify-between items-start border-b border-gold/10 pb-2.5 last:border-0 last:pb-0"
                >
          ...
          <div className="glass rounded-xl p-6">
            ...
            <div className="space-y-3">
              {PERFUMES.filter((p) => p.id !== perfume.id && p.family === perfume.family)
                .slice(0, 3)
                .map((p) => (
                  <Link
                    key={p.id}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-medium text-ivory group-hover:text-gold transition-colors truncate">
                        {p.name}
                      </p>
